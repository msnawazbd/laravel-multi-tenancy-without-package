    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('tasks.index')" :active="request()->routeIs('projects')">
                        {{ __('Tasks') }}
                    </x-nav-link>
                </div>
            </div>
                    ...
                    <x-slot name="content">
                        ...
                        @if(auth()->user()->tenants()->count() > 1)
                            @foreach(auth()->user()->tenants as $tenant)
                                <a href="{{ route('tenants.change', $tenant->id) }}" class="@if(auth()->user()->current_tenant_id == $tenant->id) font-bold text-green-600 @endif
